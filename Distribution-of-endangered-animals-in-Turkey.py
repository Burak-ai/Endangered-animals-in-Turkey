...
data = {
    "Hayvan Türü": [
        ...
        "Dağ Keçisi", "Çizgili Sırtlan", "Kelaynak Kuşu", "Turna Kuşu", 
        "Alageyik", "İnci Kefali",
    ],
    "Bölge": [
        "Akdeniz", "Ege", "Akdeniz", "Doğu Anadolu", "Karadeniz", 
        "Güneydoğu Anadolu", "Güneydoğu Anadolu", "Marmara", "Toroslar", 
        "Van Gölü",
    ],
    "Enlem": [36.5, 38.4, 36.0, 39.7, 41.1, 37.1, 37.5, 40.0, 37.3, 38.5],
    "Boylam": [30.5, 27.2, 29.0, 42.0, 37.5, 40.0, 38.8, 28.3, 32.4, 43.3],
    "Koruma Durumu": [
